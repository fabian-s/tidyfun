...
\begin{center}
\textbf{... I like it. You might, too, give it a spin!}\footnote{\emph{Currently a moving target. Still early $\beta$, some kinks need to be worked out.}}
...
Version 1.0:
  ...
  - extensions for multivariate functions
  - much more extensive documentation & tests
  - integration with **`refund`** for modeling and inference

# Thanks. \vskip 2em \href{https://github.com/fabian-s/tidyfun}{\texttt{https://github.com/fabian-s/tidyfun}} \vskip 1em \tiny I don't even have references.
